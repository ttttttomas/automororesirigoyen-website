  ...
  return (
          <section className="flex md:flex-row flex-col my-10 mx-5 to-gray-600 text-white">
            ...
            <Link href="/cars" className="md:w-1/2 rounded-t-2xl md:rounded-t-none md:rounded-l-2xl font-bold group p-8 text-white/40 hover:text-white transition-all duration-700 bg-red-900 flex flex-col justify-between">
              <h2 className="text-2xl font-bold">Encuentra el Auto Ideal para Vos</h2>
            ...
            {/* Sección de venta */}
            <Link href="/sell" className="md:w-1/2 rounded-b-2xl md:rounded-b-none md:rounded-r-2xl font-bold group p-8 text-white/40 hover:text-white transition-all duration-700 bg-black flex flex-col justify-between">
