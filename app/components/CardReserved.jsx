...
export default function Card({car}) {
  return (
    <Link href={`/cars/${car.ID}`} className='bg-white relative flex flex-col justify-between w-[290px] pb-5 hover:scale-105 rounded-2xl transition-all group cursor-pointer text-black shadow-black/30 shadow-xl'>
                <p className="absolute bg-red-500 top-0 text-white z-10 font-bold text-center my-auto bottom-0 h-6 w-full">RESERVADO</p>
