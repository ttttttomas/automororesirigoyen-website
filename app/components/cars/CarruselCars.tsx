...
export default function Carousel() {
  ...
  return (
    <section className="py-4 flex items-center justify-center relative w-full">
      <div className="flex flex-col w-1/4 items-center justify-center relative">
        <div className="flex items-center justify-center">
          ...
          <div className="flex w-[400px] mx-10 justify-center transition-all duration-300 items-center overflow-hidden">
