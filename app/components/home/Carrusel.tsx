  ...
  return (
    <section className="relative w-full md:h-200 mx-auto">
        ...
        <div className="absolute inset-0 flex justify-between flex-col items-start p-6">
          <h1 className="md:text-white text-black drop-shadow-lg shadow-black md:text-3xl text-md text-nowrap mt-26 md:mt-0 font-extrabold">¡Bienvenidos a Automotores Yrigoyen!</h1>
        </div>
    </section>
  );
}
